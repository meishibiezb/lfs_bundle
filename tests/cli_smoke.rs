...
fn inspect_prints_manifest_commit_range() {
    ...
    let manifest = lfs_bundle::core::manifest::BundleManifest {
        ...
        bundle: lfs_bundle::core::manifest::FileEntry { name: "bundle.bundle".into(), size_bytes: 6, sha256: "1".into() },
        lfs: lfs_bundle::core::manifest::FileEntry { name: "lfs.tar.gz".into(), size_bytes: 3, sha256: "2".into() },
        lfs_object_count: 0,
        created_at: "2026-03-25T00:00:00Z".into(),
    };
    lfs_bundle::core::manifest::write_manifest(&manifest_path, &manifest).unwrap();
    lfs_bundle::core::archive::build_final_archive(&archive, &bundle, &lfs, &manifest_path).unwrap();
